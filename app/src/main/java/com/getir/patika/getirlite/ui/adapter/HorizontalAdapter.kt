...
class HorizontalAdapter(private var products: List<Product>,
                        mContext: Context,
                        private val onAddButtonClick: (CartProduct) -> Unit) : RecyclerView.Adapter<HorizontalAdapter.HorizontalViewHolder>() {
